...
public class supplysearch_admin_controller {
...
private Client cli;
	...
	public void searchbuttonpressed(ActionEvent event) throws IOException{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/graphics/supply_output3.fxml"));
		root = loader.load();
		supply_output_controller3 controller = loader.getController();
		controller.setclient(cli);
		...
		list.set(0, strt);
		list.set(1, nd);
		request_operation req = new request_operation("searchsupply",list);
		cli.sendData(req);
