...
public class proposal_status_controller {
	...
	private ObservableList<proposal_output> tvObservableList = FXCollections.observableArrayList();
	...
	public void searchbuttonpressed(ActionEvent e) throws IOException, ClassNotFoundException{
		...
		ArrayList<proposal> k = (ArrayList<proposal>) cli.receiveData();	
