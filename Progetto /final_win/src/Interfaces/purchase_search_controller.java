...
public class purchase_search_controller {
...
private Client cli;
	...
	public void searchbuttonpressed(ActionEvent event) throws IOException{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/graphics/purchase_output.fxml"));
		root = loader.load();
		purchase_output_controller controller = loader.getController();
		controller.setclient(cli);
