...
/**
 *
 * The class {@code StopExecution} shows a demo
 * that run a task that waits 1 second for ten times
 * and its termination is only possible after the
 * full execution of the task.
 *
**/

public class StopExecution extends Application
{
  ...
  {
    startButton.setOnAction((e) -> runTask());
