...
public class Wine {
	...
	public Wine(final int id, final String name, final int year, final float price, final int q) {	
		this.wine_id = id;
		this.wine_name = name;
		this.wine_year = year;
	...
	public void set_quantity(final int n_quantity) {
		this.wine_quantity = n_quantity;
	}
}
