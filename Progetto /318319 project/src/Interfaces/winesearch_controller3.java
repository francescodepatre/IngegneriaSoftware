...
public class winesearch_controller3 {
...
private Client cli;
	...
	public void searchbuttonpressed(ActionEvent e) throws IOException{
		...
		cli.sendData(req);
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/graphics/wine_output_admin.fxml"));
		root = loader.load();
		wine_output_admin_controller controller = loader.getController();
		controller.setclient(cli);
