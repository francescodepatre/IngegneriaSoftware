...
public class admin_settings_controller {
	...
	public void passwordbuttonpressed(ActionEvent e) throws IOException{
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/graphics/change_password.fxml"));
		root = loader.load();
	...
	public void usernamebuttonpressed(ActionEvent e) throws IOException{
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/graphics/admin_change_username.fxml"));
		root = loader.load();
		change_admin_username_controller controller = loader.getController();
		controller.setclient(cli);
		stage = (Stage)((Node)e.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
