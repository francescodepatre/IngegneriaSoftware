...
public class proposal_search_controller2 {
...
private Client cli;
	...
	public void searchbuttonpressed(ActionEvent event) throws IOException{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/graphics/proposal_output2.fxml"));
		root = loader.load();
		proposal_output_controller2 controller = loader.getController();
		controller.setclient(cli);
