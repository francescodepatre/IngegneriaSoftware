...
import Operations.Change_seller;
...
public class change_seller_username_controller {
	...
	public void changebuttonpressed(ActionEvent event) throws IOException{
		...
		request_operation req = new request_operation("changeusername_seller",list);
		cli.sendData(req);
		*/
		new Change_seller().change_username(newpassword, 22);
