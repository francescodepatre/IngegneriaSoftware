...
public class supplysearchcontroller {
...
private Client cli;
	...
	public void searchbuttonpressed(ActionEvent event) throws IOException{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/graphics/supply_output2.fxml"));
		root = loader.load();
		supply_output_controller2 controller = loader.getController();
		controller.setclient(cli);
