...
CREATE TABLE `purchase` (
  ...
  PRIMARY KEY (`IDOrder`),
  KEY `Admin_foreignkey` (`ID_admin`),
  KEY `Customer_foreignkey` (`ID_customer`),
  KEY `Seller_foreignkey` (`ID_seller`),
  KEY `Wine_foreignkey` (`ID_wine`),
  CONSTRAINT `Admin_foreignkey` FOREIGN KEY (`ID_admin`) REFERENCES `admin` (`IDAdmin`),
  CONSTRAINT `Customer_foreignkey` FOREIGN KEY (`ID_customer`) REFERENCES `customer` (`IDCustomer`),
  CONSTRAINT `Seller_foreignkey` FOREIGN KEY (`ID_seller`) REFERENCES `seller` (`IDSeller`),
